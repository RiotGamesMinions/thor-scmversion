Feature: Bump
  ...
  Scenario: Bumping a patch version in Git
    ...
    When I run `bundle exec ruby test_project bump patch` from the temp directory
    Then the version should be '1.0.1'
    And the origin version should be '1.0.1'

  Scenario: Bumping a minor version in Git
    Given I have a git project of version '1.0.0'
    When I run `bundle exec ruby test_project bump minor` from the temp directory
    Then the version should be '1.1.0'
    And the origin version should be '1.1.0'

  Scenario: Bumping a major version in Git
    Given I have a git project of version '1.0.0'
    When I run `bundle exec ruby test_project bump major` from the temp directory
  ...
  Scenario: Bumping a patch version in Perforce
    ...
    When I run `bundle exec ruby test_project bump patch` from the Perforce project directory
  ...
  Scenario: Bumping a minor version in Perforce
    Given I have a Perforce project of version '1.0.0'
    When I run `bundle exec ruby test_project bump minor` from the Perforce project directory
  ...
  Scenario: Bumping a major version in Perforce
    Given I have a Perforce project of version '1.0.0'
    When I run `bundle exec ruby test_project bump major` from the Perforce project directory
